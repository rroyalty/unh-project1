...
const mealIngredients = $.get("https://www.themealdb.com/api/json/v1/1/list.php?i=list", function(response) {
    return response;
})

// List of Categories - Meals
const mealCategories  = $.get("https://www.themealdb.com/api/json/v1/1/list.php?c=list", function(response) {
    return response;
});
